...
class Program
{
    static void Main(string[] args)
    {
        ...
        {
new Student("Timchenko", "Stanislav", "Igorevich", new DateTime(2003, 1, 1), address, "111-1111",
new List<int> { 80, 85, 90 }),
            new Student("Boyko", "Dmitriy", "Tomatovich", new DateTime(2002, 2, 2), address, "222-2222", new List<int> { 70, 75, 80 }),
            new Student("shevchenko", "Igor", "Maksimovich", new DateTime(2001, 3, 3), address, "333-3333", new List<int> { 90, 95, 100 }),
            new Student("Kuznetsov", "Kiril", "Vladimirovich", new DateTime(2000, 4, 4), address, "444-4444", new List<int> { 60, 70, 80 }),
            new Student("Bratim", "Sergey", "Alexandrovich",
new DateTime(1999, 5, 5), address, "555-5555", new List<int> { 85, 90, 95 })
        };
        ...
        {
            Console.WriteLine($"{student.FirstName} {student.LastName} has an avg of {student.CalculateAVG()}");
        }
    }
}